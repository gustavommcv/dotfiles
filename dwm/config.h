...
static const Key keys[] = {
    ...
    {MODKEY, XK_f, spawn, {.v = filemanagercmd}}, // File manager
    {MODKEY, XK_q, killclient, {0}},              // Kill focused window
    {MODKEY, XK_space, spawn, {.v = dmenucmd}},   // Launcher
    {MODKEY, XK_b, togglebar, {0}},               // Toggle bar

    /* focus */
    {MODKEY, XK_h, focusstack, {.i = -1}}, // Focus left
    {MODKEY, XK_l, focusstack, {.i = +1}}, // Focus right
    ...
    {MODKEY, XK_p, setlayout, {0}},                // Toggle layout
    {MODKEY, XK_g, togglefloating, {0}},           // Toggle floating
